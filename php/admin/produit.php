...
<div class="container py-5">
    ...
    <div class="mb-3">
        <input type="text" id="rechercheCode" class="form-control" placeholder="Rechercher par produit...">
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    input.addEventListener('input', function () {
        ...
        rows.forEach(function (row) {
            const titre  = row.querySelector('td:nth-child(3)')?.innerText.toLowerCase() || '';
            const categorie_titre  = row.querySelector('td:nth-child(9)')?.innerText.toLowerCase() || '';
