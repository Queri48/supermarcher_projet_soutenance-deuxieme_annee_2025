        ...
        <table class="table table-bordered table-hover align-middle mb-0">
            ...
            <tbody>
                <?php foreach ($utilisateurs as $index => $user): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="modifier_employe.php?id=<?= $user['id'] ?>" class="btn btn-sm btn-outline-success me-1">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="supprimer_employe.php?id=<?= $user['id'] ?>" class="btn btn-sm btn-outline-danger">
                ...
                <?php if (empty($utilisateurs)): ?>
                    <tr>
                        <td colspan="9" class="text-center text-muted">Aucun employer trouvé.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
